...
def load_data(dataset, seed=0):
    if dataset == 'cora':
        ...
        num_classes = 12
        class_desc = pd.read_csv("../categories/photo_categories.csv")
        ...
        num_classes = 12
        class_desc = pd.read_csv("../categories/computer_categories.csv")
        classes = class_desc['name'].tolist()
        c_descs = class_desc['description'].tolist()
    elif dataset == 'history':
        from data.data_utils.load_history import get_raw_text_history as get_raw_text
        class_desc = pd.read_csv("../categories/history_categories.csv")
        classes = class_desc['name'].tolist()
        c_descs = class_desc['description'].tolist()
